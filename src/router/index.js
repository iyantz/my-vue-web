...
export const dynamicRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'defect',
        component: () => import('@/views/task/defect/index.vue'),
        name: 'Defect',
  ...
  },
  {
    path: '/release',
    component: Layout,
    meta: { title: '项目发布管理', icon: 'release' },
    children: [
      {
        path: 'plan',
        component: () => import('@/views/release/plan/index.vue'),
        name: 'ReleasePlan',
        meta: { title: '发布计划', icon: 'time' }
      },
      {
        path: 'list',
